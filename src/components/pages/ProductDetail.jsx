    ...
    <>
      ...
      <Section>
        ...
        <p>
          ...
          Laudantium voluptate ut, soluta cupiditate qui ex esse beatae ea
          maxime repellat.
        </p>
        <p>
          Quasi vel aperiam voluptatibus sunt, soluta quas facilis, rerum atque
          corrupti sequi laudantium adipisci numquam corporis, quos qui? Odit
          sed temporibus mollitia voluptates dolores eveniet optio, quae
          sapiente natus. Atque.
        </p>
        ...
        <Callout>
          <CalloutBody>
            ...
            <p>
              ...
              temporibus officia. Amet impedit enim, placeat nam inventore
              tempore est magnam eveniet odio dolor molestias provident nostrum
              vitae animi reprehenderit excepturi.
            </p>
            <CalloutAction>
